...
part swap --asprimary --fstype="swap" --size=4096 --ondisk=sda
...
logvol /tmp --fstype ext4 --vgname vg_root --name tmp --size=4096 --fsoptions="strictatime,nodev,nosuid,noexec"
# CIS 1.1.6 Partition for /var
logvol /var --fstype ext4 --vgname=vg_root --name var --size=4096
# CIS 1.1.7-1.1.10 Partition for /var/tmp with correct options
logvol /var/tmp --fstype ext4 --vgname vg_root --name vartmp --size=1024 --fsoptions="nodev,nosuid,noexec"
# CIS 1.1.11 Partition for /var/log
logvol /var/log --fstype ext4 --vgname vg_root --name log --size=2048
# CIS 1.1.12 Partition for /var/log/audit
logvol /var/log/audit --fstype ext4 --vgname vg_root --name audit --size=2048
# CIS 1.1.13-1.1.14  Partition for /home with correct options
logvol /home --fstype ext4 --vgname vg_root --name home --size=40960  --fsoptions="nodev"
logvol /var/lib/docker --fstype ext4 --vgname vg_root --name vldocker  --size=20480  --fsoptions="nodev"
